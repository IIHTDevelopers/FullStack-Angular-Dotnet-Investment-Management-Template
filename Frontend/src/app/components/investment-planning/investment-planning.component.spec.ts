...
describe('InvestmentPlanningComponent', () => {
  ...
  describe('boundary', () => {
    ...
    it('should update an existing investment', () => {
      ...
      // Normalize dates by removing milliseconds
      const normalizeDate = (date: string | number | Date) => new Date(date).setMilliseconds(0);
    
      const expectedInvestment = {
        investmentId: 0,
        investmentName: '',
        initialInvestmentAmount: 0,
        investmentStartDate: normalizeDate(new Date()),
        currentValue: 0,
        investorId: 0
      };
    
      const receivedInvestment = {
        investmentId: component.investment.investmentId,
        investmentName: component.investment.investmentName,
        initialInvestmentAmount: component.investment.initialInvestmentAmount,
        investmentStartDate: normalizeDate(component.investment.investmentStartDate),
        currentValue: component.investment.currentValue,
        investorId: component.investment.investorId
      };
    
      expect(receivedInvestment).toEqual(expectedInvestment);
